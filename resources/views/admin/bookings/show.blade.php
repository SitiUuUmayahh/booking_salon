        ...
        @if($booking->dp_status === 'pending')
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border-2 border-yellow-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <!-- WhatsApp Button -->
                    <a href="{{ $booking->whatsapp_admin_link }}" target="_blank" class="w-full block bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-bold py-4 px-4 rounded-lg transition transform hover:scale-105 shadow-lg text-center">
                        <span class="flex items-center justify-center">
