        ...
        <div class="bg-white rounded-lg shadow-xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <div class="flex justify-between items-center pt-6 border-t border-gray-200 gap-2">
                    ...
                    <!-- WhatsApp Button -->
                    <a href="{{ $booking->whatsapp_customer_link }}" target="_blank" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center">
